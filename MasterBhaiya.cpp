...
#define FIXED_THREAD_COUNT 600  // Number of threads for attack
...
int main(int argc, char *argv[]) {
    ...
    if (config.duration <= 0 || config.payload_size <= 0) {
        std::cerr << "[!] Duration and payload_size must be positive\n";
        return EXIT_FAILURE;
    }
